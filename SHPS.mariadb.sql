--
-- Install Script for SHPS 3.0 U2 [MARIADB]
--
...
CREATE TABLE IF NOT EXISTS `HP_browser` (
  ...
  PRIMARY KEY (`ID`),
  KEY `name` (`name`)
) ENGINE=Aria  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci PAGE_CHECKSUM=1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `HP_css` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=Aria  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci PAGE_CHECKSUM=0 TRANSACTIONAL=1 AUTO_INCREMENT=1 ;
...
(
   ...
   PRIMARY KEY  ( `ID` ),
   UNIQUE `keys` ( `name`,`namespace` )
) ENGINE = Aria CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = PAGE TRANSACTIONAL = 1 COMMENT = 'CoffeeScript';
...
CREATE TABLE IF NOT EXISTS `HP_key` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `accesskey` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `HP_language` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `name` (`name`)
) ENGINE=Aria  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci PAGE_CHECKSUM=1 TRANSACTIONAL=1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `HP_php` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `head` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'function head',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=Aria  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci PAGE_CHECKSUM=0 TRANSACTIONAL=1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `HP_plugin` (
  `GUID` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL PRIMARY KEY,
  `plugin` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `HP_string` (
  ...
  KEY `keys` (`langID`,`namespace`,`group`,`key`)
...
CREATE TABLE IF NOT EXISTS `HP_upload` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `filename` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `upload_time` int(11) NOT NULL,
  `mimetype` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'image/png',
...
CREATE TABLE IF NOT EXISTS `HP_user` (
  ...
  `pass` varchar(129) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `salt` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `host` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
